...
urlpatterns = [
    ...
    path("add-category/", views.add_category, name="dashboard-add-category"),
    path("edit-category/<cid>/", views.edit_category, name="dashboard-edit-category"),
    path("delete-category/<cid>/", views.delete_category, name="dashboard-delete-category"),
]
