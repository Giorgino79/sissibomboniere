...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100, default="Categoria", verbose_name="Nome")
    image = models.ImageField(upload_to="category", default="category.jpg", verbose_name="Immagine")
...
class Product(models.Model):
    ...
    title = models.CharField(max_length=100, default="Prodotto", verbose_name="Nome")
    image = models.ImageField(
        upload_to=user_directory_path, default="product.jpg", verbose_name="Immagine")
    description = CKEditor5Field(config_name='extends', null=True, blank=True, verbose_name="Descrizione")

    price = models.DecimalField(
        max_digits=12, decimal_places=2, default="0.00", verbose_name="Prezzo")
    old_price = models.DecimalField(
        max_digits=12, decimal_places=2, default="0.00", null=True, blank=True, verbose_name="Prezzo precedente")
